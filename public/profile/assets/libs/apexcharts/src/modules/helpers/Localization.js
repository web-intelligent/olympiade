...
export default class Localization {
  ...
  setCurrentLocaleValues(localeName) {
    ...
    // check if profile has specified locales in global Apex variable
    ...
    // find the locale from the array of locales which profile has set (either by chart.defaultLocale or by calling setLocale() method.)
