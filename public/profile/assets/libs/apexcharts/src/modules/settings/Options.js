  ...
  init() {
    return {
      ...
      tooltip: {
        ...
        intersect: false, // when enabled, tooltip will only show when profile directly hovers over point
        inverseOrder: false,
        custom: undefined,
        ...
        x: {
          ...
          formatter: undefined // a custom profile supplied formatter function
        },
        y: {
          formatter: undefined,
          title: {
