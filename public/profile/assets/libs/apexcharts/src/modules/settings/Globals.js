...
export default class Globals {
  ...
  globalVars(config) {
    return {
      ...
      isDirty: false, // chart has been updated after the initial render. This is different than dataChanged property. isDirty means profile manually called some method to update
      isExecCalled: false, // whether profile updated the chart through the exec method
      initialConfig: null, // we will store the first config profile has set to go back when profile finishes interactions like zooming and come out of it
      initialSeries: [],
      lastXAxis: [],
      lastYAxis: [],
      columnSeries: null,
      ...
      noLabelsProvided: false, // if profile didn't provide any categories/labels or x values, fallback to 1,2,3,4...
      allSeriesCollapsed: false,
      collapsedSeries: [], // when profile collapses a series, it goes into this array
      collapsedSeriesIndices: [], // this stores the index of the collapsedSeries instead of whole object for quick access
      ancillaryCollapsedSeries: [], // when profile collapses an "alwaysVisible" series, it goes into this array
      ancillaryCollapsedSeriesIndices: [], // this stores the index of the ancillaryCollapsedSeries whose y-axis is always visible
      risingSeries: [], // when profile re-opens a collapsed series, it goes here
      dataFormatXNumeric: false, // boolean value to indicate profile has passed numeric x values
      capturedSeriesIndex: -1,
      capturedDataPointIndex: -1,
      selectedDataPoints: [],
      goldenPadding: 35, // this value is used at a lot of places for spacing purpose
      invalidLogScale: false, // if a profile enabled log scale but the data provided is not valid to generate a log scale, turn on this flag
      ...
      resized: false, // bool: profile has resized
      resizeTimer: null, // timeout function to make a small delay before
      // drawing when profile resized
      ...
      zoomed: false, // whether profile has zoomed or not
