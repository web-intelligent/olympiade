...
export default class Annotations {
  ...
  // The addXaxisAnnotation method requires a parent class, and profile calling this method externally on the chart instance may not specify parent, hence a different method
