...
class Formatters {
  ...
  xLabelFormat(fn, val, timestamp, opts) {
    ...
    if (w.config.xaxis.type === 'datetime') {
      if (w.config.xaxis.labels.formatter === undefined) {
        // if profile has not specified a custom formatter, use the default tooltip.x.format
  ...
  setLabelFormatters() {
    ...
    // legend formatter - if profile wants to append any global values of series to legend text
