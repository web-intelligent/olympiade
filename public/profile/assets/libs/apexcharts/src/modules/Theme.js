...
export default class Theme {
  ...
  setDefaultColors() {
    ...
    if (w.config.colors === undefined) {
      ...
      // if profile provided a function in colors, we need to eval here
      if (
    ...
    // profile defined colors in series array
    ...
    // if profile specified fewer colors than no. of series, push the same colors again
