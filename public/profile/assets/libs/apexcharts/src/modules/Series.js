...
export default class Series {
  ...
  getActiveConfigSeriesIndex(ignoreBars = false, order = 'asc') {
    ...
    if (w.config.series.length > 1) {
      // active series flag is required to know if profile has not deactivated via legend click
  ...
  // When profile clicks on legends, the collapsed series is filled with [0,0,0,...,0]
